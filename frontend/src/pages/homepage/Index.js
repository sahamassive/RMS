    ...
    <div>
      ...
      <header id="header" className="fixed-top d-flex align-items-cente">
        <div className="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
          <div className='dis'>
          <h3 className="logo me-auto me-lg-0"><a href="index.html"><img src={ require('./assets/img/logo/logo.png') } alt=""></img> 
            </a>
            </h3>
      ...
      <main id="main">
          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="row">
              ...
              <div className="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content writing-style">
                <h3 className='writing-style'>We provide for the most worthy food and taste, as if the pleasures of the body and mind were to be assumed.</h3>
                ...
                <div className="tab-content">
                  <div className="tab-pane active show" id="tab-1">
                    <div className="row">
                      ...
                      <div className="col-lg-4 text-center order-1 order-lg-2">
                        <img src={require('./assets/img/specials-1.png') } alt="" className="img-fluid"></img>
                      </div>
                    </div>
                  </div>
                  <div className="tab-pane" id="tab-2">
                    <div className="row">
                      ...
                      <div className="col-lg-4 text-center order-1 order-lg-2">
                        <img src={require('./assets/img/specials-2.png') } alt="" className="img-fluid"></img>
                      </div>
                    </div>
                  </div>
                  <div className="tab-pane" id="tab-3">
                    <div className="row">
                      ...
                      <div className="col-lg-4 text-center order-1 order-lg-2">
                        <img src={require('./assets/img/specials-3.png') } alt="" className="img-fluid"></img>
                      </div>
                    </div>
                  </div>
                  <div className="tab-pane" id="tab-4">
                    <div className="row">
                      ...
                      <div className="col-lg-4 text-center order-1 order-lg-2">
                        <img src={require('./assets/img/specials-4.png') } alt="" className="img-fluid"></img>
                      </div>
                    </div>
                  </div>
                  <div className="tab-pane" id="tab-5">
                    <div className="row">
                      ...
                      <div className="col-lg-4 text-center order-1 order-lg-2">
                        <img src={require('./assets/img/specials-5.png') } alt="" className="img-fluid"></img>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="events-slider swiper" data-aos="fade-up" data-aos-delay="100">
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="row event-item">
                    <div className="col-lg-6">
                      <img src={require('./assets/img/event-birthday.jpg') } className="img-fluid" alt=""></img>
                    </div>
                    <div className="col-lg-6 pt-4 pt-lg-0 content">
                      ...
                      <ul>
                        <li><i className="bi bi-check-circled"></i> Talk about your birthday and the celebrations you have planned.</li>
                        <li><i className="bi bi-check-circled"></i> You just imagine, We will make it live.</li>
                        <li><i className="bi bi-check-circled"></i> Your birthday our responsibility.</li>
                      </ul>
                      <p>
                ...
                <div className="swiper-slide">
                  <div className="row event-item">
                    <div className="col-lg-6">
                      <img src={require('./assets/img/event-private.jpg') } className="img-fluid" alt=""></img>
                    </div>
                    <div className="col-lg-6 pt-4 pt-lg-0 content">
                ...
                <div className="swiper-slide">
                  <div className="row event-item">
                    <div className="col-lg-6">
                      <img src={require('./assets/img/event-custom.jpg') } className="img-fluid" alt=""></img>
                    </div>
                    <div className="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <form action="forms/book-a-table.php" method="post" role="form" className="php-email-form" data-aos="fade-up" data-aos-delay="100">
              <div className="row">
                <div className="col-lg-4 col-md-6 form-group">
                  <input type="text" name="name" className="form-control" id="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars"></input>
                  <div className="validate"></div>
                </div>
                <div className="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
                  <input type="email" className="form-control" name="email" id="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email"></input>
                  <div className="validate"></div>
                </div>
                <div className="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" className="form-control" name="phone" id="phone" placeholder="Your Phone" data-rule="minlen:4" data-msg="Please enter at least 4 chars"></input>
                  <div className="validate"></div>
                </div>
                <div className="col-lg-4 col-md-6 form-group mt-3">
                  <input type="text" name="date" className="form-control" id="date" placeholder="Date" data-rule="minlen:4" data-msg="Please enter at least 4 chars"></input>
                  <div className="validate"></div>
                </div>
                <div className="col-lg-4 col-md-6 form-group mt-3">
                  <input type="text" className="form-control" name="time" id="time" placeholder="Time" data-rule="minlen:4" data-msg="Please enter at least 4 chars"></input>
                  <div className="validate"></div>
                </div>
                <div className="col-lg-4 col-md-6 form-group mt-3">
                  <input type="number" className="form-control" name="people" id="people" placeholder="# of people" data-rule="minlen:1" data-msg="Please enter at least 1 chars"></input>
                  <div className="validate"></div>
                </div>
              </div>
              ...
              <div className="swiper-wrapper">
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    <p>
                      ...
                      The atmosphere was cool & very Gentle. You could spend your quality time with your special one here.                  <i className="bx bxs-quote-alt-right quote-icon-right"></i>
                    </p>
                    <img src={require('./assets/img/testimonials/testimonials-1.jpg') } className="testimonial-img" alt=""></img>
                    <h3>Saul Goodman</h3>
                    <h4>Ceo &amp; Founder</h4>
                  </div>
                </div>
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    <p>
                      <i className="bx bxs-quote-alt-left quote-icon-left"></i>
                      I think the quantity was rice was usual and more than enough for one person. We were 7 and we took 3platters which were sufficient for us.❣️                  <i className="bx bxs-quote-alt-right quote-icon-right"></i>
                    </p>
                    <img src={require("./assets/img/testimonials/testimonials-2.jpg")} className="testimonial-img" alt=""></img>
                    <h3>Sara Wilsson</h3>
                    <h4>Designer</h4>
                  </div>
                </div>
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    ...
                    <img src={require("./assets/img/testimonials/testimonials-4.jpg")} className="testimonial-img" alt=""></img>
                    <h3>Matt Brandon</h3>
                    <h4>Freelancer</h4>
                  </div>
                </div>
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    ...
                    <img src={require("./assets/img/testimonials/testimonials-5.jpg")} className="testimonial-img" alt=""></img>
                    <h3>John Larson</h3>
                    <h4>Entrepreneur</h4>
                  </div>
                </div>
              ...
              <div className="col-lg-3 col-md-4">
                <div className="gallery-item">
                  <a href="assets/img/gallery/gallery-1.jpg" className="gallery-lightbox" data-gall="gallery-item">
                    <img src={require("./assets/img/gallery/gallery-1.jpg" )}alt="" className="img-fluid"></img>
                  </a>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-4">
                <div className="gallery-item">
                  <a href="assets/img/gallery/gallery-2.jpg" className="gallery-lightbox" data-gall="gallery-item">
                    <img src={require("./assets/img/gallery/gallery-2.jpg")} alt="" className="img-fluid"></img>
                  </a>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-4">
                <div className="gallery-item">
                  <a href="assets/img/gallery/gallery-3.jpg" className="gallery-lightbox" data-gall="gallery-item">
                    <img src={require("./assets/img/gallery/gallery-3.jpg")} alt="" className="img-fluid"></img>
                  </a>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-4">
                <div className="gallery-item">
                  <a href="assets/img/gallery/gallery-4.jpg" className="gallery-lightbox" data-gall="gallery-item">
                    <img src={require("./assets/img/gallery/gallery-4.jpg")} alt="" className="img-fluid"></img>
                  </a>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-4">
                <div className="gallery-item">
                  <a href="assets/img/gallery/gallery-5.jpg" className="gallery-lightbox" data-gall="gallery-item">
                    <img src={require("./assets/img/gallery/gallery-5.jpg")} alt="" className="img-fluid"></img>
                  </a>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-4">
                <div className="gallery-item">
                  <a href="assets/img/gallery/gallery-6.jpg" className="gallery-lightbox" data-gall="gallery-item">
                    <img src={require("./assets/img/gallery/gallery-6.jpg")} alt="" className="img-fluid"></img>
                  </a>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-4">
                <div className="gallery-item">
                  <a href="assets/img/gallery/gallery-7.jpg" className="gallery-lightbox" data-gall="gallery-item">
                    <img src={require("./assets/img/gallery/gallery-7.jpg")} alt="" className="img-fluid"></img>
                  </a>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-4">
                <div className="gallery-item">
                  <a href="assets/img/gallery/gallery-8.jpg" className="gallery-lightbox" data-gall="gallery-item">
                    <img src={require("./assets/img/gallery/gallery-8.jpg")} alt="" className="img-fluid"></img>
                  </a>
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="member" data-aos="zoom-in" data-aos-delay="100">
                  <img src={ require('./assets/img/chefs/chefs-1.jpg') } className="img-fluid image-size" alt=""></img>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="member" data-aos="zoom-in" data-aos-delay="200">
                  <img src={ require('./assets/img/chefs/chefs-2.jpg')} className="img-fluid image-size" alt=""></img>
                  <div className="member-info">
                    <div className="member-info-content">
                      <h4>Sarah Jhonson</h4>
                      <span>Patissier</span>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="member" data-aos="zoom-in" data-aos-delay="300">
                  <img src={ require('./assets/img/chefs/chefs-3.jpg')} className="img-fluid image-size" alt=""></img>
                  <div className="member-info">
                    <div className="member-info-content">
        ...
        <section id="contact" className="contact">
          ...
          <div data-aos="fade-up">
            <iframe className='map-style' src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb89d1fe6bc499443!2sDowntown+Conference+Center!5e0!3m2!1smk!2sbg!4v1539943755621" frameBorder="0" allowFullScreen></iframe>
          </div>
